...
function Best11() {
  ...
  const yourURL = "https://ballondor2025.netlify.app/World%20XI/masculin";
    ...
    <div style={{ padding: '40px', textAlign: 'center' }}>
      ...
      <select
        ...
        onChange={(e) => {
          ...
          setFormation(value);
          setSelectedPlayers(formationRoles[value]?.map(() => '') || []);
          setSubmitted(false);
        }}
      >
      ...
      {submitted && (
        <div style={{ marginTop: '20px' }}>
          ...
          <br />
          <button onClick={downloadImage} style={{ marginTop: '20px', fontFamily: 'Figtree'}}>{t('download11')}</button>
